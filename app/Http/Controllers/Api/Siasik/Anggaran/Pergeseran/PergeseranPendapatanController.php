...
class PergeseranPendapatanController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = Anggaran_Pendapatan::where('anggaran_pendapatan.tahun',$tahun)
        ->join('t_tampung_pendapatan', 't_tampung_pendapatan.notrans', 'anggaran_pendapatan.notrans')
         ->select('anggaran_pendapatan.*',
