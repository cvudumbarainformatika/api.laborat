        ...
        $rwobat->with([
            'saldoawal' => function ($st) use ($blnLalu) {
                $st->select(
                    ...
                    'stokopname.harga',
                    DB::raw('sum(stokopname.jumlah) as jumlah'),
                    DB::raw('FLOOR(sum(stokopname.jumlah * stokopname.harga)*100)/100 as sub'),
            ...
            'penerimaanrinci' => function ($trm) {
                $trm->select(
                    ...
                    DB::raw('FLOOR(sum(penerimaan_r.harga_netto_kecil * penerimaan_r.jml_terima_k)*100)/100 as sub')
                )
            ...
            'resepkeluar' => function ($kel) {
                $kel->select(
                    ...
                    DB::raw('FLOOR(sum(resep_keluar_r.jumlah * resep_keluar_r.harga_beli)*100)/100 as sub')
            ...
            'distribusipersiapan' => function ($dist) {
                $dist->select(
                    ...
                    DB::raw('FLOOR(sum(persiapan_operasi_distribusis.jumlah * daftar_hargas.harga)*100)/100 as sub'),
            ...
            'persiapanretur' => function ($dist) {
                $dist->select(
                    ...
                    DB::raw('FLOOR(sum(persiapan_operasi_distribusis.jumlah_retur * daftar_hargas.harga)*100)/100 as sub'),
            ...
            'resepkeluarracikan' => function ($kel) {
                $kel->select(
                    ...
                    DB::raw('FLOOR(sum(resep_keluar_racikan_r.jumlah * resep_keluar_racikan_r.harga_beli)*100)/100 as sub')
            ...
            'returpenjualan' => function ($kel) {
                $kel->select(
                    ...
                    DB::raw('FLOOR(sum(retur_penjualan_r.jumlah_retur * retur_penjualan_r.harga_beli)*100)/100 as sub'),
            ...
            'mutasikeluar' => function ($mut) {
                $mut->select(
                    ...
                    DB::raw('FLOOR(sum(mutasi_gudangdepo.jml * mutasi_gudangdepo.harga)*100)/100 as sub'),
                    'permintaan_h.dari',
            ...
            'penyesuaian' => function ($pak) {
                $pak->select(
                    ...
                    DB::raw('FLOOR(sum(penyesuaian_stoks.penyesuaian * stokreal.harga)*100)/100 as sub'),
            ...
            'barangrusak' => function ($pak) {
                $pak->select(
                    ...
                    DB::raw('FLOOR(sum(jumlah * harga_net_default)*100)/100 as sub'),
            ...
            'returpbf' => function ($kel) {
                $kel->select(
                    ...
                    DB::raw('FLOOR(sum(retur_penyedia_r.jumlah_retur * retur_penyedia_r.harga_net_default)*100)/100 as sub'),
            ...
            'pengembalianrincififo' => function ($kel) {
                $kel->select(
                    ...
                    DB::raw('FLOOR(sum(pengembalian_rinci_fifos.jml_dikembalikan * pengembalian_rinci_fifos.harga)*100)/100 as sub'),
