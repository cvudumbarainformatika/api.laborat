...
class DischargePlanningController extends Controller
{
    ...
    public function simpandataskrining(Request $request)
    {
        ...
        $data = SkriningPulang::create([
            ...
            'rs3' => date('Y-m-d H:i:s'),
            'rs4' => $request->rs4,
            'rs4Ket' => $request->rs4Ket,
            'rs5' => $request->rs5,
            'rs5Ket' => $request->rs5Ket,
            'rs6' => $request->rs6,
            'rs6Ket' => $request->rs6Ket,
            'rs7' => $request->rs7,
            'rs7Ket' => $request->rs7Ket,
            'rs8' => $request->rs8,
            'rs9' => $request->rs9,
            'rs9Ket' => $request->rs9Ket,
            'rs10' => $request->rs10,
            'rs10Ket' => $request->rs10Ket,
            'rs11' => $request->rs11,
            'rs11Ket' => $request->rs11Ket,
            'rs12' => $request->rs12,
            'rs12Ket' => $request->rs12Ket,
            'rs13' => $request->rs13,
            'rs13Ket' => $request->rs13Ket,
            'rs14' => $request->rs14,
            'rs14Ket' => $request->rs14Ket,
            'rs15' => $request->rs15,
            'rs15Ket' => $request->rs15Ket,
            'rs16' => $request->rs16,
            'rs16Ket' => $request->rs16Ket,
            'rs17' => $request->rs17,
            'rs17Ket' => $request->rs17Ket,
            'rs18' => $request->rs18,
            'rs18Ket' => $request->rs18Ket,
            'rs19' => $request->rs19,
            'rs19Ket' => $request->rs19Ket,
            'rs20' => $request->rs20,
            'rs21' => $request->rs21,
            'rs22' => $request->rs22,
            'rs22Ket' => $request->rs22Ket,
            'kdruang' => $request->kdruang,
