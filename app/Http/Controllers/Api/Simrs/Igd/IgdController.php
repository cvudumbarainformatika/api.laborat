...
class IgdController extends Controller
{
    ...
    public function kunjunganigdgeneralconsent()
    {
        if (request('to') === '' || request('from') === null) {
            $tgl = Carbon::now()->format('Y-m-d 00:00:00');
            $tglx = Carbon::now()->format('Y-m-d 23:59:59');
        ...
        $wew = KunjunganPoli::query()
            ...
            ->leftjoin('rs9', 'rs9.rs1', '=', 'rs17.rs14') //sistembayar
            ->leftjoin('rs222', 'rs222.rs1', '=', 'rs17.rs1') //sep
            ->leftjoin('gencons', 'gencons.noreg', '=', 'rs17.rs1')
            // ->leftjoin('bpjs_respon_time', 'bpjs_respon_time.noreg', '=', 'rs17.rs1')
            ->whereBetween('rs17.rs3', [$tgl, $tglx])
            ...
            ->with([
                ...
                // },
                'generalconsigd:norm,noreg,ttdpasien,ttdpetugas,hubunganpasien,pdf',
                // 'bpjshttprespon'
            ])
