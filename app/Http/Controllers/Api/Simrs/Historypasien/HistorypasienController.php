...
class HistorypasienController extends Controller
{
    ...
    {
        $kunjungan = Mpasien::select('rs1',DB::raw('concat(rs3," ",gelardepan," ",rs2," ",gelarbelakang) as nama'),
        DB::raw('concat(rs4," KEL ",rs5," RT ",rs7," RW ",rs8," ",rs6," ",rs11," ",rs10) as alamat'),'rs16 as tgllahir','rs17 as kelamin','rs19 as pendidikan',
        'rs22 as agama','rs37 as templahir','rs39 as suku','rs40 as jenispasien','rs46 as noka','rs49 as nktp','rs55 as nohp')
        ->with(
            [
