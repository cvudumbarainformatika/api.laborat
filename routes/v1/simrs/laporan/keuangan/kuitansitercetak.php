...
use App\Http\Controllers\Api\Simrs\Laporan\Keuangan\KuitansiTercetakController;
...
Route::group([
    ...
    //Laporan
    Route::get('/kuitansitercetak',[KuitansiTercetakController::class, 'kuitansitercetak']);
});
