...
Route::group([
    ...
    Route::get('/bastsigarang', [NPD_LSController::class, 'bastSigarang']);
    ...
    Route::post('/updatedataxx', [NPD_LSController::class, 'updatedata']);


    Route::post('/updatenopenerimaan', [NPD_LSController::class, 'updateNopenerimaan']);
